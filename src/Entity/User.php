...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Establishment::class, inversedBy="belong")
     */
    private $user_link;
    ...
    public function getUserLink(): ?Establishment
    {
        return $this->user_link;
    }

    public function setUserLink(?Establishment $user_link): self
    {
